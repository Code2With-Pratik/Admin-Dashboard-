...
const Services = () => {
  ...
  const followersData = filteredData.filter(
    (item) => item.name === "Instagram Followers"
  );
  const likesData = filteredData.filter(
    (item) => item.name === "Instagram Likes"
  );
  ...
  const {
    ...
    currentPageData: currentFollowersData,
  } = paginate(followersData, currentPageFollowers);
  const { totalPages: totalLikesPages, currentPageData: currentLikesData } =
    paginate(likesData, currentPageLikes);
    ...
    <div className="p-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center space-x-2 bg-gray-800 rounded-md p-1 px-2">
          ...
          >
            <option className="bg-gray-800 text-white" value="name">
              Name
            </option>
            <option className="bg-gray-800 text-white" value="status">
              Status
            </option>
            <option className="bg-gray-800 text-white" value="provider">
              Provider
            </option>
            <option className="bg-gray-800 text-white" value="type">
              Type
            </option>
          </select>
        </div>
      ...
      <table className="w-full border-collapse mb-4">
        {renderTable(currentFollowersData)}
      </table>
      {renderPagination(
        totalFollowersPages,
